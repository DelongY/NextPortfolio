...
const Projects: Project[] = [
  {
    ...
    imageUrl: '/assets/delongxportfolio.jpg',
  ...
  },
  {
    id: 'aio-hub',
    title: 'AIO Hub',
    description: 'A hub contains many useful tools for developers, built with Next.js and TailwindCSS.',
    longDescription: 'A hub contains many useful tools for developers. Built with Next.js and tailwind, it features tools like code color picker, and more.',
    technologies: ['Next.js', 'React', 'Typescript', 'TailwindCSS'],
    imageUrl: '/assets/aiohub.jpg',
    githubUrl: '',
    liveUrl: 'https://allinonehub.vercel.app/',
    category: 'fullstack',
  },
  {
